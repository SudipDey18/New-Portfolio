    ...
    <>
      ...
      <div className="w-full flex max-sm:flex-col max-sm:mt-8 mt-12 max-sm:items-center">
        <div className="min-w-[400px] flex justify-center max-sm:items-center max-sm:flex-col">
          <Card className="w-[85%] h-[450px] bg-blue-600 rounded-tr-[60px] rounded-bl-[60px] flex items-center justify-center max-sm:scale-90 in-annimation cursor-not-allowed sta">
            <img
              src="react.png"
              color="#18A5D9"
            ...
            <div className="w-[85%] h-[400px] bg-rose-600 border-0 rounded-tr-[40px] rounded-bl-[40px] flex items-center justify-center in-annimation cursor-not-allowed">
              <div className="w-[81%] h-[350px] bg-purple-400 border-0 rounded-tr-[20px] rounded-bl-[20px] overflow-hidden justify-end in-annimation cursor-move">
